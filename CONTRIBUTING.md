...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/domain_price.git`).
...
Go to the [pull request page of DomainPrice][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/domain_price/issues/new
[GitHub issues]: https://github.com/signmotion/domain_price/issues/new
[PRs]: https://github.com/signmotion/domain_price/pulls
